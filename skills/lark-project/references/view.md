...
视图搜索与固定视图管理。读取视图数据用 `meegle-cli view get`（见 SKILL.md 主文件）。

## meegle-cli view search
按名称搜索视图。
...
## meegle-cli view list-multi-project-workitems
