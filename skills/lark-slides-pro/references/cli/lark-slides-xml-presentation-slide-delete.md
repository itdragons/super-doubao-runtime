...
```bash
lark-cli slides xml_presentation.slide delete --params '<json_params>'
```
...
```bash
lark-cli slides xml_presentation.slide delete --params '{
  "xml_presentation_id": "slides_example_presentation_id",
  "slide_id": "slide_example_id"
}'
```
...
# 然后按已知 slide_id 删除
lark-cli slides xml_presentation.slide delete --params '{"xml_presentation_id":"slides_example_presentation_id","slide_id":"slide_example_id"}'
```
...
```bash
lark-cli slides xml_presentation.slide create --params '{"xml_presentation_id":"slides_example_presentation_id"}' --data '{
  "slide": {
    "content": "<slide xmlns=\"https://www.larkoffice.com/sml/2.0\"><data><shape type=\"text\" topLeftX=\"80\" topLeftY=\"80\" width=\"800\" height=\"120\"><content textType=\"title\"><p>新页面</p></content></shape></data></slide>"
  }
}'
```
...
for slide_id in sld_a sld_b sld_c; do
  lark-cli slides xml_presentation.slide delete --params "{\"xml_presentation_id\":\"slides_example_presentation_id\",\"slide_id\":\"$slide_id\"}"
done
```
